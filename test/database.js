...
//             const getRandomValue = await database.kvdata.get('randomValue');
//             assert.equal(getRandomValue, randomValue);
//             const setValue = { A: ['啊', 1, NaN, false, null, { B: null }]};
//             await database.kvdata.set('test', setValue);
//             const getValue = await database.kvdata.get('test');
//             assert.deepEqual(setValue, getValue);
//         });
//     });
